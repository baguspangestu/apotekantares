      ...
      <div class="row">
        <div class="form-group col-md-6">
          ...
          <select name="kd_suplier" id="kd_suplier" class="form-control" required>
            ...
            ?>
              <option value="<?php echo $dd['kd']; ?>" <?php echo isset($_GET['kd_suplier']) && ($_GET['kd_suplier'] == $dd['kd']) ? 'selected' : '' ?>>
        ...
        <div class="form-group col-md-6">
          ...
          <input autocomplete="off" type="date" name="tanggal" value="<?php echo date('Y-m-d'); ?>" class="form-control" <?php echo isset($_GET['kd_suplier']) && !empty($_GET['kd_suplier']) ? '' : 'disabled' ?> required />
        </div>
      </div>
      <hr />
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <div class="d-flex">
              <span id="listProdukButton" class="btn btn-primary btn-block mr-2 <?php echo isset($_GET['kd_suplier']) && !empty($_GET['kd_suplier']) ? '' : 'disabled' ?>"><i class="fas fa-search"></i> Pilih
                Produk
              </span>
