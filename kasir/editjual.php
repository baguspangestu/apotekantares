...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $listPembelianAwalKeys = array_column($listPembelianAwal, null, 'kd');
  $listPembelianEditKeys = array_column($listPembelianEdit, null, 'kd');

  foreach ($listPembelianAwal as &$itemAwal) {
    $key = $itemAwal['kd'];
    $isE = isset($listPembelianEditKeys[$key]);
    $itemAwal['jumlah'] = $isE ? $listPembelianEditKeys[$key]['jumlah'] : 0;
  }

  foreach ($listPembelianEdit as $itemEdit) {
    $key = $itemEdit['kd'];
    $isA = isset($listPembelianAwalKeys[$key]);
    if (!$isA) $listPembelianAwal[] = $itemEdit;
  }

  $listPembelian = array_values($listPembelianAwal);
    ...
    <div class="card-body">
      <div class="row">
        <div class="form-group col-md-6">
          ...
          <input autocomplete="off" type="text" name="pembeli" value="<?php echo $transaksiAwalData['pembeli']; ?>" class="form-control" />
        </div>
        <div class="form-group col-md-6">
          <label class="font-weight-bold">Tanggal Transaksi</label>
          <input autocomplete="off" type="date" name="tanggal" value="<?php echo $transaksiAwalData['tanggal']; ?>" class="form-control" required>
        </div>
      </div>
      <hr />
      <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <an class="input-group-text" id="tpSatuan">
                  <textan>
              </div>
              ...
              <table class="table table-bordered table-striped">
                <tbody class="font-weight-bold">
                  <tr>
                    ...
                    <td>
                      <div class="input-group">
                        <input autocomplete="off" type="number" name="diskon" value="<?php echo $transaksiAwalData['diskon'] ?>" id="diskon" class="form-control" placeholder="0">
                        <div class="input-group-append">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input autocomplete="off" type="text" value="<?php echo $transaksiAwalData['tunai'] ?>" id="tunai" class="form-control" />
