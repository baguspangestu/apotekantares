		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="stok" required class="form-control" value="<?php echo $data['stok']; ?>" />
				</div>

				<div class="form-group col-md-6">
					<label class="font-weight-bold">Harga Modal</label>
					<input autocomplete="off" type="text" name="harga_modal" required class="form-control" value="<?php echo $data['harga_modal']; ?>" />
				</div>
...
if (isset($_POST['submit'])) {
	...
	mysqli_query($konek, "UPDATE produk SET kd_kategori = '$kd_kategori', nama = '$nama', harga_jual = '$harga_jual' WHERE kd = '$kd'");
	mysqli_query($konek, "UPDATE detail_produk SET tgl_exp = '$tgl_exp', harga_modal = '$harga_modal', stok = '$stok' WHERE kd_produk = '$kd'");
